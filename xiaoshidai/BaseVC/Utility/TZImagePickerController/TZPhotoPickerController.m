...
- (void)configBottomToolBar {
    ...
    bottomToolBar.backgroundColor = [UIColor DisplayP3Red:rgb green:rgb blue:rgb alpha:1.0];
    ...
    divide.backgroundColor = [UIColor DisplayP3Red:rgb2 green:rgb2 blue:rgb2 alpha:1.0];

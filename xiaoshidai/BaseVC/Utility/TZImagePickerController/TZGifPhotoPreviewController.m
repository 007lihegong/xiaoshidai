...
- (void)configBottomToolBar {
    ...
    _toolBar.backgroundColor = [UIColor DisplayP3Red:rgb green:rgb blue:rgb alpha:0.7];
    ...
    if (tzImagePickerVc) {
        ...
        [_doneButton setTitleColor:[UIColor DisplayP3Red:(83/255.0) green:(179/255.0) blue:(17/255.0) alpha:1.0] forState:UIControlStateNormal];
    }

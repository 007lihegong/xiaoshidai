...
//
#define LTColor(r, g, b, a) [UIColor DisplayP3Red:(r)/255.0 green:(g)/255.0 blue:(b)/255.0 alpha:(a)]
...
-(void)loadUI{
    ...
    [self.myToolbar.items enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL *stop) {
        ...
        NSDictionary * attributes = @{NSForegroundColorAttributeName: MyBlueColor};

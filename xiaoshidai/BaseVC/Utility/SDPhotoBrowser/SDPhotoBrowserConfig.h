...
// browser背景颜色
#define SDPhotoBrowserBackgrounColor [UIColor DisplayP3Red:0 green:0 blue:0 alpha:0.95]
...
// 图片下载进度指示器背景色
#define SDWaitingViewBackgroundColor [UIColor DisplayP3Red:0 green:0 blue:0 alpha:0.7]

...
#define BADGE_BG_COLOR_DEFAULT [UIColor DisplayP3Red:252 / 255.0f green:15 / 255.0f blue:29 / 255.0f alpha:1.0f]
...
- (void)updateSubViewsWhenParentScrollViewScroll:(UIScrollView *)scrollView {
    ...
    if (self.itemColorChangeFollowContentScroll) {
        ...
        leftItem.titleLabel.textColor = [UIColor DisplayP3Red:leftScale * redDiff + normalRed
                                                        green:leftScale * greenDiff + normalGreen
                                                         blue:leftScale * blueDiff + normalBlue
                                                        alpha:leftScale * alphaDiff + normalAlpha];
        rightItem.titleLabel.textColor = [UIColor DisplayP3Red:rightScale * redDiff + normalRed

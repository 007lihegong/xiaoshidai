...
@property (nonatomic, strong)   CustomScrollView     *mainView;                 // content view
@property (nonatomic, strong) SCNavTabBar               *navTabBar;                // NavTabBar: press item on it to exchange view

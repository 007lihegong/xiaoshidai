...
- (void)awakeFromNib
{
    ...
    self.inputTextView.layer.borderColor = [UIColor DisplayP3Red:184/255.0 green:184/255.0 blue:184/255.0 alpha:1].CGColor;
    // 发送键盘通知
...
- (void)setBtnDisabled
{
    ...
    self.inputTextView.placeholderColor = [UIColor DisplayP3Red:184/255.0 green:184/255.0 blue:184/255.0 alpha:1];
...
- (void)show
{
    ...
    // 输入框
    self.frame = CGRectMake(0, 0, becloudView.frame.size.width * 0.8, 230);
...
- (IBAction)confirmBtnClick:(UIButton *)sender {
    ...
    if (self.confirmBlock) {
        self.confirmBlock(self.inputTextView.text ,self.textField.text);
    }
}

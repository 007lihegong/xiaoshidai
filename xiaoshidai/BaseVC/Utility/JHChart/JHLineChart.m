...
- (void)updateYScale{
        ...
        if (max<=5) {
            for (NSInteger i = 0; i<5; i++) {
                ...
                [arr addObject:[NSString stringWithFormat:@"%ld",(long)(i+1)*1]];
                [minArr addObject:[NSString stringWithFormat:@"-%ld",(long)(i+1)*1]];
                }
            }
        ...
        if (max<=10&&max>5) {
            ...
            for (NSInteger i = 0; i<5; i++) {
                    ...
                    [arr addObject:[NSString stringWithFormat:@"%ld",(long)(i+1)*2]];
                [minArr addObject:[NSString stringWithFormat:@"-%ld",(long)(i+1)*2]];
                ...
                for (NSInteger i = 0; i<max/5; i++) {
                    [arr addObject:[NSString stringWithFormat:@"%ld",(long)(i+1)*5]];
                    [minArr addObject:[NSString stringWithFormat:@"-%ld",(long)(i+1)*5]];
                }
            ...
            if (_valueArr.count) {
                ...
                if (max<=10&&max>5) {
                    ...
                    for (NSInteger i = 0; i<10; i++) {
                        [arr addObject:[NSString stringWithFormat:@"%ld",(long)(i+1)*per]];
                    }
                }

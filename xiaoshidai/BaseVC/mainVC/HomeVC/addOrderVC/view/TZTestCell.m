...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        [_deleteBtn setBackgroundImage:[UIImage imageNamed:@"head_icon_samlldelet"] forState:UIControlStateNormal];
        [self addSubview:_deleteBtn];
        
        _gifLable = [[UILabel alloc] init];
        _gifLable.text = @"GIF";
        _gifLable.textColor = [UIColor whiteColor];
        _gifLable.backgroundColor = [UIColor DisplayP3Red:0 green:0 blue:0 alpha:0.8];

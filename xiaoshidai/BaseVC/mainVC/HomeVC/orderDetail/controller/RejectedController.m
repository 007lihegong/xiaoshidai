...
@interface RejectedController ()<UITableViewDelegate,UITableViewDataSource>
{
    int page;
}
...
@implementation RejectedController
...
-(void)request{
    ...
    [param setObject:[self setRSAencryptString:@"3"] forKey:@"pay_status"];
    ...
    if (self.channel_id) {
        ...
        tokenArr = @[@{@"price":key,@"vaule":[NSString stringWithFormat:@"%@%@",key,id_solution]},
                     ...
                     @{@"price":@"pay_status",@"vaule":[NSString stringWithFormat:@"pay_status%@",@"3"]}
                     ];
    }else{
        tokenArr = @[@{@"price":key,@"vaule":[NSString stringWithFormat:@"%@%@",key,id_solution]},
                     @{@"price":@"currentPage",@"vaule":[NSString stringWithFormat:@"currentPage%@",[NSString stringWithFormat:@"%d",page]]},

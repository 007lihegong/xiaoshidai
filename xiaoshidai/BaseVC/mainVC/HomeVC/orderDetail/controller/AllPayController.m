...
@interface AllPayController ()<UITableViewDelegate,UITableViewDataSource>
{
    int page;
}
...
@implementation AllPayController
...
-(UITableView *)tableView{
    if (!_tableView) {
        ...
        //NSArray *nibArrays = [[UINib nibWithNibName:@"PayCell" bundle:nil] instantiateWithOwner:nil options:nil];
        //[_tableView registerClass:[[nibArrays objectAtIndex:0] class] forCellReuseIdentifier:@"PayCellID"];
      //  [_tableView registerClass:[[nibArrays objectAtIndex:1] class] forCellReuseIdentifier:@"PayCellID1"];

...
- (void)initSubviews {
    CGFloat cellHeigth = MyCellHeight;
    ...
    self.selectedImageView.image = [UIImage imageNamed:@"nav_icon_nor"];
    //self.selectedImageView.backgroundColor = MyBlueColor;
...
- (void)setSelected:(BOOL)selected {
  ...
  if (selected) {
    _selectedImageView.image = [UIImage imageNamed:@"nav_icon_selet1"];
  } else {
    _selectedImageView.image = [UIImage imageNamed:@"nav_icon_nor"];
  }

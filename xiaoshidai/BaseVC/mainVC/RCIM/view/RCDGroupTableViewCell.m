...
- (void)initSubviews {
    ...
    CGFloat cellHeight = MyCellHeight;
    //群组头像
    ...
    //切圆角
    self.imvGroupPort.layer.masksToBounds = NO;
    //self.imvGroupPort.layer.cornerRadius = 18.f;

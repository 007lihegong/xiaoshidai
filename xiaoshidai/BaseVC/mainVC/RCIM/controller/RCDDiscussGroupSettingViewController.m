...
- (UITableViewCell *)tableView:(UITableView *)tableView
  ...
  case 0: {
    ...
    discussCell.lblDiscussName.text = self.conversationTitle;
      ...
      discussCell.lblTitle.text = LocalizationNotNeeded(@"讨论组名称");
    cell = discussCell;
  ...
  case 1: {
    if (self.isOwner) {
      ...
      switchCell.label.text =  LocalizationNotNeeded(@"开放成员邀请");
      [[RCIMClient sharedRCIMClient] getDiscussion:self.targetId
          success:^(RCDiscussion *discussion) {
        ...
        [[RCIM sharedRCIM] createDiscussion:discussionTitle
            ...
            success:^(RCDiscussion *discussion) {
              ...
              dispatch_async(dispatch_get_main_queue(), ^{
                ...
                chat.tabBarItem.title = discussion.discussionName;
...
- (void)didTipHeaderClicked:(NSString *)userId {
  if (_isClick) {
    _isClick = NO;
      ...
      UserInfo * user = (UserInfo *)[[RCIM sharedRCIM] getUserInfoCache:userId];

...
@interface PictureCell ()<SDPhotoBrowserDelegate,TZImagePickerControllerDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UIActionSheetDelegate,UIImagePickerControllerDelegate,UIAlertViewDelegate,UINavigationControllerDelegate>{
    CGFloat _itemWH;
    CGFloat _margin;
...
-(void)initUI{
    ...
    [_backImageView setImage:IMGNAME(@"nav_icon_add") forState:(UIControlStateNormal)];
    ...
    [_backImageView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.size.mas_equalTo(CGSizeMake(37, 30));
...
- (UICollectionView *)collectionView{
    if (!_collectionView) {
        ...
        _margin = 4;
        _itemWH = (kScreen_Width - 4 * _margin - 4) / 5 - _margin;
        layout.itemSize = CGSizeMake(_itemWH, _itemWH);
        layout.minimumInteritemSpacing = _margin;
        layout.minimumLineSpacing = _margin;
        _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, kScreen_Width, 135) collectionViewLayout:layout];
...
+(CGFloat)cellHeightWith:(NSMutableArray *)arr{
    PictureCell *cell = [[PictureCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"Cell011"];
